...
public class MissionsEditEmployeRecommande implements ActionListener {
	...
	public MissionsEditEmployeRecommande(JTable Poss, JTable nonPoss, GenericTableModel PossModel,TableModel nonPossModel, Missions m) {

...
public class CSVModel {
	...
	public CSVModel() {
		...
		//metadata.AddAssociationOrEntity(CompetenceRequirement.class, null, RELATIVEPATH + "competences_req.csv", true, 0	);
		//metadata.AddAssociationOrEntity(Mission.class, null, RELATIVEPATH + "liste_missions.csv", true, 0);
	//	metadata.AddAssociationOrEntity(Employee.class, Competence.class, RELATIVEPATH + "competences_personnel.csv", true, 0);
	//	metadata.AddAssociationOrEntity(Mission.class, Employee.class, RELATIVEPATH + "missions_personnel.csv", true, 0);
	//	metadata.AddAssociationOrEntity(Mission.class, CompetenceRequirement.class, RELATIVEPATH + "missions_competences.csv", true, 0);

...
public class Program {
	...
	public static void main(String[] args)
			throws IOException, InvalidCSVException, InvalidDataException, ParseException, CSVUpdateException {
		{
			
			Toolkit tk = Toolkit.getDefaultToolkit();
			
			try {
				BufferedImage cursorNotAllowedImage = ImageIO
						.read(Program.class.getClass().getResource("/cursors/not_allowed2.png"));
				...
				BufferedImage cursorGrabbingImage = ImageIO
						.read(Program.class.getClass().getResource("/cursors/grabbing.png"));
				GRABBED_CURSOR = tk.createCustomCursor(cursorGrabbingImage, new Point(7, 8), "Grabbing");
				
				BufferedImage cursorLeftPointerImage = ImageIO
						.read(Program.class.getClass().getResource("/cursors/left_ptr.png"));
				LEFT_POINTER_CURSOR = tk.createCustomCursor(cursorLeftPointerImage, new Point(0, 0), "Pointer");
				
				BufferedImage cursorPointingHandImage = ImageIO
						.read(Program.class.getClass().getResource("/cursors/pointing_hand.png"));
